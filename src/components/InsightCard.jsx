...
export default function InsightCard({ title, value, description, color = 'blue', info }) {
  ...
  return (
    <div className={`bg-white rounded-lg border border-slate-200 border-l-4 ${borderClass} p-5`}>
      <p className="text-xs font-medium uppercase tracking-wide text-slate-500">{title}{info && <InfoTip text={info} />}</p>
